...
public class ChunkProviderHeaven implements IChunkProvider
{
    ...
    private net.minecraft.world.gen.structure.MapGenScatteredFeature scatteredFeatureGenerator = new net.minecraft.world.gen.structure.MapGenScatteredFeature();
...
public ChunkPosition func_147416_a(World p_147416_1_, String p_147416_2_,
	...
	return null;
} at: http://www.wuppy29.com/minecraft/modding-tutorials/wuppys-minecraft-forge-modding-tutorials-for-1-7-updating-1-6-to-1-7-part-8-worldprovider-and-chunkprovider/#sthash.IjNkI0KI.dpuf