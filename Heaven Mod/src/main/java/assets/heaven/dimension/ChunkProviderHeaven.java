...
public class ChunkProviderHeaven implements IChunkProvider
{
    ...
    private MapGenBase caveGenerator = new MapGenCavesHeaven();
    private MapGenMineshaftHeaven mineshaftGenerator = new MapGenMineshaftHeaven();
    private MapGenBase ravineGenerator = new MapGenRavineHeaven();
    /**
...

    {
        ...
        mineshaftGenerator = (MapGenMineshaftHeaven) TerrainGen.getModdedMapGen(mineshaftGenerator, MINESHAFT);
      ...
      /*  if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, var11, LAVA) && !var11 && this.rand.nextInt(4) == 0)
		{
			...
			{
				(new WorldGenLavaLakesHeaven(Blocks.lava)).generate(this.worldObj, this.rand, var12, var13, var14);
			}
		}
		...
		for (int k = 0; k < 1; k++)
		{
			...
			(new WorldGenHeavenTree()).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
		} */
		...
		for (int k = 0; k < 10; k++)
		{
			...
			new WorldGenMinable(BlockHandler.SkyStone, 34, Blocks.stone).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
		}
		/*
		...
		for (int k = 0; k < 30; k++)
		{
			...
			int RandPosY = rand.nextInt(64);
			int RandPosZ = var5 + rand.nextInt(16);
			new WorldGenMinable(Blocks.iron_ore, 6, Blocks.stone).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
		}
		...
		for (int k = 0; k < 4; k++)
		{
			...
			int RandPosY = rand.nextInt(64);
			int RandPosZ = var5 + rand.nextInt(16);
			new WorldGenMinable(Blocks.gold_ore, 4, Blocks.stone).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
		}
		...
		for (int k = 0; k < 2; k++)
		{
			...
			int RandPosZ = var5 + rand.nextInt(16);
			(new WorldGenMinable(Blocks.diamond_ore, 3, Blocks.stone)).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
		}
		
		//More Generations Options:
