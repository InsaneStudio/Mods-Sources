...
public class HeavenPortal extends BlockBreakable
	{
		protected HeavenPortal(String p_i45411_1_, Material p_i45411_2_,
			boolean p_i45411_3_) {
		...
		public boolean getPortalSize(World world, int x, int y, int z) {
			HeavenPortal.Size size = new HeavenPortal.Size(world, x, y, z, 1);
			HeavenPortal.Size size1 = new HeavenPortal.Size(world, x, y, z, 2);
		...
		public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
			if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
				...
				if (thePlayer.timeUntilPortal > 0) {
					...
					thePlayer.timeUntilPortal = 10;
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, dimensionRegistry.dimensionID, new TeleporterHeaven(thePlayer.mcServer.worldServerForDimension(dimensionRegistry.dimensionID)));
				} else {
					thePlayer.timeUntilPortal = 10;
		...
		public static class Size
		{
			...
			public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
			{
				...
				this.field_150863_d = HeavenPortal.field_150001_a[p_i45415_5_][0];
				this.field_150866_c = HeavenPortal.field_150001_a[p_i45415_5_][1];
			...
			protected int func_150853_a(int x, int y, int z, int p_150853_4_)
			{
				...
				for (i1 = 0; i1 < 22; ++i1)
				{
					...
					if (block1 != BlockHandler.SkyStone)
					{
						break;
					}
				}
				...
				block = this.worldObj.getBlock(x + j1 * i1, y, z + k1 * i1);
				return block == BlockHandler.SkyStone ? i1 : 0;
			}
			...
			protected int func_150858_a()
			{
				...
				label56:
					...
					for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
					{
						...
						{
							k = this.field_150861_f.posX + j * Direction.offsetX[HeavenPortal.field_150001_a[this.field_150865_b][1]];
							l = this.field_150861_f.posZ + j * Direction.offsetZ[HeavenPortal.field_150001_a[this.field_150865_b][1]];
							...
							if (block == BlockHandler.HeavenPortal)
							{
								++this.field_150864_e;
							}
							...
							if (j == 0)
							{
								block = this.worldObj.getBlock(k + Direction.offsetX[HeavenPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[HeavenPortal.field_150001_a[this.field_150865_b][0]]);

								if (block != BlockHandler.SkyStone)
								{
									break label56;
								}
							}
							...
							{
								block = this.worldObj.getBlock(k + Direction.offsetX[HeavenPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[HeavenPortal.field_150001_a[this.field_150865_b][1]]);
				...
				{
					j = this.field_150861_f.posX + i * Direction.offsetX[HeavenPortal.field_150001_a[this.field_150865_b][1]];
					k = this.field_150861_f.posY + this.field_150862_g;
					l = this.field_150861_f.posZ + i * Direction.offsetZ[HeavenPortal.field_150001_a[this.field_150865_b][1]];

					if (this.worldObj.getBlock(j, k, l) != BlockHandler.SkyStone)
					{
			...
			protected boolean getBlockMaterial(Block block){
				return block.getMaterial() == Material.air || block == BlockHandler.HeavenFire || block == BlockHandler.HeavenPortal;
			}
			...
			public void func_150859_c()
			{
				for (int i = 0; i < this.field_150868_h; ++i)
				{
					...
					for (int l = 0; l < this.field_150862_g; ++l)
					{
						...
						this.worldObj.setBlock(j, i1, k, BlockHandler.HeavenPortal, this.field_150865_b, 2);
					}
				}
			}
		}
